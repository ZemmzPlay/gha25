                                    ...
                                    <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="left" style="font-family: arial, 'Century Gothic', Arial, sans-serif; color:#6e667b; font-size:22px;font-weight: bold; text-transform: uppercase">
                                                ...
                                                <br/>
                                                <span style="color: #3EA651;">Workshop</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
                                        ...
                                        <tr>
                                            <td align="left" style="font-family: arial, 'Century Gothic', Arial, sans-serif; color:#00000; font-size:18px;">
                                                ...
                                                <p style="font-size: 15px; line-height:24px;">
                                                    These are the workshop details
                                                </p>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <table width="100%" class="table-inner">
                                                                            <tbody>
                                                                            <tr>
                                                                                <td width="80" align="left" valign="top" style="font-family: arial, 'Open Sans', Arial, sans-serif; font-size:14px; line-height:36px; padding: 0 10px; background-color: #3EA651; color: #ffffff; border-bottom: 1px solid #ffffff;">Title</td>
                                                                                ...
                                                                                <td width="200" align="left" valign="top" style="font-family: arial, 'Open Sans', Arial, sans-serif; font-size:14px; line-height:36px; padding: 0 10px;  font-weight: bold; background-color: #e5f6ec; border-bottom: 1px solid #ffffff;">{{ $registration->Workshop->title }}</td>
                                                                            </tr>
                                                                            {{-- </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                {{-- <tr>
                                                                    <td align="center">
                                                                        <table width="100%" class="table-inner" border="0" cellspacing="0" cellpadding="0">
                                                                            <tbody> --}}
                                                                            <tr>
                                                                                <td width="80" align="left" valign="top" style="font-family: arial, 'Open Sans', Arial, sans-serif; font-size:14px; line-height:36px; padding: 0 10px; background-color: #3EA651; color: #ffffff; border-bottom: 1px solid #ffffff;">Price</td>
                                                                                {{-- <td width="20" align="left" valign="top" style="font-family: arial, 'Open Sans', Arial, sans-serif; font-size:14px; line-height:36px; padding: 0 10px;  font-weight: bold;"></td> --}}
                                                                                <td width="200" align="left" valign="top" style="font-family: arial, 'Open Sans', Arial, sans-serif; font-size:14px; line-height:36px; padding: 0 10px;  font-weight: bold;background-color: #e5f6ec; border-bottom: 1px solid #ffffff;">{{$registration->Workshop->price}}</td>
                                                                            </tr>
                                                                            {{-- </tbody>
                                                                        </table>
                                                                    </td>
