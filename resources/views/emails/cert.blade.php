                                    ...
                                    <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="left" style="font-family: arial, 'Century Gothic', Arial, sans-serif; color:#6e667b; font-size:22px;font-weight: bold; text-transform: uppercase">
                                                <br/>
                                                <span style="color: #3EA651;">Get Certificate Steps</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="5"></td>
                                        ...
                                        <tr>
                                            <td align="left" style="font-family: arial, 'Century Gothic', Arial, sans-serif; color:#6e667b; font-size:16px;font-weight: bold;line-height: 1.3;">
                                                <span style="color: #3EA651;">Dear {{$name}}, here are the instructions on how to obtain the certificate.</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="left" style="font-family: arial, 'Century Gothic', Arial, sans-serif; color:#00000; font-size:18px;">
                                                <p style="font-size: 15px; line-height:24px;">
                                                    <b>Go to the main page of the website:</b> In the certificate section, enter the ID you received via email and click on the "Claim" button.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left">
                                                                <img width="100%" style="display:block; line-height:0px; font-size:0px; border:0px;" src="{{asset('images/cert/1.JPG')}}" alt="img" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="left" style="font-family: arial, 'Century Gothic', Arial, sans-serif; color:#00000; font-size:18px;">
                                                <p style="font-size: 15px; line-height:24px;">
                                                    complete the evaluation form and click "Submit" to provide your review and get your certificate.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left">
                                                                <img width="100%" style="display:block; line-height:0px; font-size:0px; border:0px;" src="{{asset('images/cert/2.png')}}" alt="img" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
