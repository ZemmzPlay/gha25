...
<h1 style="text-align: center; margin-top: 190px; margin-bottom:5px; text-transform: capitalize; font-size:18px">{{$registration->title}}. {{$registration->first_name}} {{$registration->last_name}}</h1>
