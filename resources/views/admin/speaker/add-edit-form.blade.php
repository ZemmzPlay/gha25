...
@section('breadcrumps')
    <ol class="breadcrumb mb-0">
        ...
        <li><a href="{{url('admin/speaker')}}">Speakers</a></li>
        @if($method == 'post')
            <li class="active">New Speaker</li>
        @else
            <li>{{$speaker->name}}</li>
        @endif
    </ol>
        ...
        <form class="form-horizontal" method="post">
            ...
            <div class="widget-heading clearfix">
                ...
                <div class="pull-right">
                    ...
                    <a class="btn btn-default" href="{{url('admin/speaker')}}"><i class="ti-arrow-left"></i></a>
                </div>
            </div>
            ...
            <div class="widget-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="name" type="text" class="form-control" name="name" required value="{{(isset($speaker) ? $speaker->name : '')}}">
                    </div>
                </div>
            </div>
        </form>
