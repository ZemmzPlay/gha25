...
@section('content')
				...
				<div class="oneSlide carousel-item">
					@if($slideshow->active)
			    		...
			    		<a href="{{$link}}" target="_blank">
			    			<button class="oneSlideButton {{($slideshow->buttonTheme == 2) ? 'oneSlideButtonLight' : ''}}">Add to Calendar <i class="fa-solid fa-calendar-days"></i></button>
			    		</a>
		    		@endif
		    		<img class="oneSlideImage" src="{{ asset('images/slideshow/'.$slideshow->image) }}" alt="Logo">
		    		<img class="oneSlideImageMobile" src="{{ asset('images/slideshow/'.$slideshow->image_mobile) }}" alt="Logo">
		    	</div>
	    	@endforeach
		</div>
	@endif
		...
		<div class="registerMiddle">
				...
				<form method="post" id="registerForm" action="{{route('registrations.create')}}">
                	...
                	<div class="registerInputsContainer">
						...
						<div class="registerOneInputContainer" id="firstNameInput">
							...
							<input type="text" name="first_name" class="registerOneInputValue" placeholder="Name" value="{{old('first_name')}}" required />
						</div>
						<div class="registerOneInputContainer" id="lastNameInput">
							<div class="registerOneInputLabel">Last</div>
							<input type="text" name="last_name" class="registerOneInputValue" placeholder="Name" value="{{old('last_name')}}" required />
						</div>
						...
						<div class="registerOneInputContainer" id="specialityInput">
							...
							<input type="text" name="speciality" class="registerOneInputValue" placeholder="Speciality" value="{{old('speciality')}}" required />
						</div>
						<div class="registerOneInputContainer" id="countryInput">
							...
							<select name="country" class="registerOneInputValue" required>
								...
								<option value="Kuwait" {{(old('country') && old('country') == 'Kuwait') ? 'selected' : ''}}>Kuwait</option>
								<option value="Saudi Arabia" {{(old('country') && old('country') == 'Saudi Arabia') ? 'selected' : ''}}>Saudi Arabia</option>
								<option value="Iran" {{(old('country') && old('country') == 'Iran') ? 'selected' : ''}}>Iran</option>
								<option value="Egypt" {{(old('country') && old('country') == 'Egypt') ? 'selected' : ''}}>Egypt</option>
								<option value="Qatar" {{(old('country') && old('country') == 'Qatar') ? 'selected' : ''}}>Qatar</option>
								<option value="United Arab Emirates" {{(old('country') && old('country') == 'United Arab Emirates') ? 'selected' : ''}}>United Arab Emirates</option>
								<option value="Syria" {{(old('country') && old('country') == 'Syria') ? 'selected' : ''}}>Syria</option>
								<option value="Iraq" {{(old('country') && old('country') == 'Iraq') ? 'selected' : ''}}>Iraq</option>
								<option value="Jordan" {{(old('country') && old('country') == 'Jordan') ? 'selected' : ''}}>Jordan</option>
								<option value="Lebanon" {{(old('country') && old('country') == 'Lebanon') ? 'selected' : ''}}>Lebanon</option>
								<option value="Tunisia" {{(old('country') && old('country') == 'Tunisia') ? 'selected' : ''}}>Tunisia</option>
								<option value="Morocco" {{(old('country') && old('country') == 'Morocco') ? 'selected' : ''}}>Morocco</option>
								<option value="Yemen" {{(old('country') && old('country') == 'Yemen') ? 'selected' : ''}}>Yemen</option>
								<option value="Bahrain" {{(old('country') && old('country') == 'Bahrain') ? 'selected' : ''}}>Bahrain</option>
								<option value="Oman" {{(old('country') && old('country') == 'Oman') ? 'selected' : ''}}>Oman</option>
								<option value="Algeria" {{(old('country') && old('country') == 'Algeria') ? 'selected' : ''}}>Algeria</option>
								<option value="Libya" {{(old('country') && old('country') == 'Libya') ? 'selected' : ''}}>Libya</option>
								<option value="Palestine" {{(old('country') && old('country') == 'Palestine') ? 'selected' : ''}}>Palestine</option>
								<option value="Sudan" {{(old('country') && old('country') == 'Sudan') ? 'selected' : ''}}>Sudan</option>
								<option value="Djibouti" {{(old('country') && old('country') == 'Djibouti') ? 'selected' : ''}}>Djibouti</option>
							</select>
						</div>
						<div class="registerOneInputContainer" id="cityInput">
							<div class="registerOneInputLabel">City</div>
							<input type="text" name="city" class="registerOneInputValue" placeholder="Kuwait" value="{{old('city')}}" required />
						</div>
						<div class="registerOneInputContainer" id="emailInput">
							<div class="registerOneInputLabel">Email</div>
							<input type="text" name="email" class="registerOneInputValue" placeholder="emailid@domain.com" value="{{old('email')}}" required />
						</div>
						<div class="registerOneInputContainer" id="numberInput">
							...
							<div class="twoInputsPhone">
								<select name="countryCode" class="twoInputsPhoneSmall" required>
								    <option value="+965" {{ (old('countryCode') && old('countryCode') == '+965') ? 'selected' : '' }}>+965 (Kuwait)</option>
								    <option value="+966" {{ (old('countryCode') && old('countryCode') == '+966') ? 'selected' : '' }}>+966 (Saudi Arabia)</option>
								    <option value="+98" {{ (old('countryCode') && old('countryCode') == '+98') ? 'selected' : '' }}>+98 (Iran)</option>
								    <option value="+20" {{ (old('countryCode') && old('countryCode') == '+20') ? 'selected' : '' }}>+20 (Egypt)</option>
								    <option value="+974" {{ (old('countryCode') && old('countryCode') == '+974') ? 'selected' : '' }}>+974 (Qatar)</option>
								    <option value="+971" {{ (old('countryCode') && old('countryCode') == '+971') ? 'selected' : '' }}>+971 (United Arab Emirates)</option>
								    <option value="+963" {{ (old('countryCode') && old('countryCode') == '+963') ? 'selected' : '' }}>+963 (Syria)</option>
								    <option value="+964" {{ (old('countryCode') && old('countryCode') == '+964') ? 'selected' : '' }}>+964 (Iraq)</option>
								    <option value="+962" {{ (old('countryCode') && old('countryCode') == '+962') ? 'selected' : '' }}>+962 (Jordan)</option>
								    <option value="+961" {{ (old('countryCode') && old('countryCode') == '+961') ? 'selected' : '' }}>+961 (Lebanon)</option>
								    <option value="+216" {{ (old('countryCode') && old('countryCode') == '+216') ? 'selected' : '' }}>+216 (Tunisia)</option>
								    <option value="+212" {{ (old('countryCode') && old('countryCode') == '+212') ? 'selected' : '' }}>+212 (Morocco)</option>
								    <option value="+967" {{ (old('countryCode') && old('countryCode') == '+967') ? 'selected' : '' }}>+967 (Yemen)</option>
								    <option value="+973" {{ (old('countryCode') && old('countryCode') == '+973') ? 'selected' : '' }}>+973 (Bahrain)</option>
								    <option value="+968" {{ (old('countryCode') && old('countryCode') == '+968') ? 'selected' : '' }}>+968 (Oman)</option>
								    <option value="+213" {{ (old('countryCode') && old('countryCode') == '+213') ? 'selected' : '' }}>+213 (Algeria)</option>
								    <option value="+218" {{ (old('countryCode') && old('countryCode') == '+218') ? 'selected' : '' }}>+218 (Libya)</option>
								    <option value="+970" {{ (old('countryCode') && old('countryCode') == '+970') ? 'selected' : '' }}>+970 (Palestine)</option>
								    <option value="+249" {{ (old('countryCode') && old('countryCode') == '+249') ? 'selected' : '' }}>+249 (Sudan)</option>
								    <option value="+253" {{ (old('countryCode') && old('countryCode') == '+253') ? 'selected' : '' }}>+253 (Djibouti)</option>
								</select>
								<input type="text" name="mobile" class="twoInputsPhoneNumber" placeholder="5000 9876" value="{{old('mobile')}}" required />
							</div>
						</div>
						<div class="registerOneInputContainer" id="emptySpaceInput"></div>
					</div>
					...
					<div class="workshopSection" style="display: none;">
						...
						<div class="registerOneInputContainer" id="onlyWorkshopInput">
							<div class="onlyWorkshopContainer">
								<div data-element="onlyWorkshop" class="registerCheckbox {{(old('onlyWorkshop') && old('onlyWorkshop') == '1') ? 'registerCheckboxChecked' : ''}}"></div> <!-- registerCheckboxChecked -->
								<input type="hidden" name="onlyWorkshop" class="registerCheckboxReal" value="{{(old('onlyWorkshop')) ? old('onlyWorkshop') : '0'}}" />
							...
							<select name="workshop_id" class="registerOneInputValue">
								...
								@if(count($workshops))
									@foreach($workshops as $workshop)
										<option value="{{$workshop->id}}" data-price="{{$workshop->price}}" {{(old('workshop_id') && old('workshop_id') == $workshop->id) ? 'selected' : ''}}>{{$workshop->title}}</option>
									@endforeach
								@endif
							</select>
						</div>
					...
					<div class="registerButtonContainerOut">
						<div class="registerButtonContainer" id="registerSubmitButton">
							...
							<div class="registerButtonRight">
								...
								?>
								<div class="registerButtonRightText {{$normalPricePayClass}}" id="normalPricePay">KD <span class="finalRegistrationPrice">{{(old('virtualAccess') && old('virtualAccess') == '1') ? '10' : 20}}</span></div>
						...
						<div class="termsText">By registering you agree to the <a href="{{ url('/terms-and-conditions') }}" target="_blank"><u>Terms & Conditions</u></a> of the 15th GHA Meeting registration guidelines.</div>
					</div>
			...
			@if(Settings::get('certificates_enabled') && !Settings::get('registration_enabled'))
                ...
                <form method="post" id="certificateForm" action="{{route('registration.verify')}}">
                    ...
                    <div class="certificateTitleID">Please use your registration ID (in the confirmation email) to claim your certificate.</div>
                    <input type="hidden" name="request_type" value="certificate">
                    <div class="registerOneInputContainer" id="IDInput">
						<input type="text" name="id" class="registerOneInputValue" placeholder="* Your ID" value="{{old('id')}}" required />
					</div>
	...
	<div class="endorsement-container">
		<img class="endorsement-image mobile-first-two" src="{{ asset('images/home/endo1.png') }}" alt="Endorsed 1" />
		<img class="endorsement-image mobile-first-two" src="{{ asset('images/home/endo2.png') }}" alt="Endorsed 2" />
		<span class="endorsement-text">Endorsed By</span>
		<img class="endorsement-image mobile-last-four" src="{{ asset('images/home/endo3.png') }}" alt="Endorsed 3" />
		<img class="endorsement-image mobile-last-four mobile-last-two" src="{{ asset('images/home/endo/endo4.jpg') }}" alt="Endorsed 4" />
		<img class="endorsement-image mobile-last-four mobile-last-two" src="{{ asset('images/home/endo/endo5.jpg') }}" alt="Endorsed 5" />
	</div>
		...
		<div class="allSponsors">
			...
			<div class="oneSponsor">
				...
				<div class="industryParkSponsor">
					<div class="industryParkSponsorText">Industry Park Sponsors</div>
				...
				<div class="publicSponsor">
					<div class="publicSponsorText">Public Day Sponsor</div>
				...
				<div class="supportSponsor">
					<div class="supportSponsorText">Support Sponsor</div>
